...
`
      ...
      <style jsx>{`
        ...
        .figma-2 {
          ...
          pointer-events: auto;
          z-index: 1;
          margin-right: 8.00006103515625px;
          width: 28px;
          min-width: 28px;
          height: 28px;
          margin-top: 0px;
        ...
        .figma-10 {
          ...
          pointer-events: auto;
          z-index: 3;
          margin-right: 80.00006103515625px;
          width: 20px;
          min-width: 20px;
          height: 20px;
          margin-top: 0px;
        ...
        .figma-14 {
          ...
          pointer-events: auto;
          z-index: 4;
          margin-left: 111.99993896484375px;
          margin-right: 116.00006103515625px;
          flex-grow: 1;
          height: 26px;
          margin-top: 0px;
          background-color: rgba(0, 0, 0, 0);
        ...
        .figma-16 {
          ...
          pointer-events: auto;
          z-index: 5;
          margin-left: 71.99993896484375px;
          width: 28px;
          min-width: 28px;
          height: 28px;
          margin-top: 0px;
        ...
        .figma-20 {
          ...
          pointer-events: auto;
          z-index: 6;
          margin-left: 39.99993896484375px;
          width: 28px;
          min-width: 28px;
          height: 28px;
          margin-top: 0px;
